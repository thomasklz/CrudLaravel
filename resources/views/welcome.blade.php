...
<head>
    ...
    <link rel="stylesheet" href="assets/vendor/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
                  ...
                  <!-- .fieldset -->
                   @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  aria-describedby="tf1Help" name="prod">
