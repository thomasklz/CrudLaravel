...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css')}} "><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
                  ...
                  @method('put')
                   @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $producto->producto}}" class="form-control"  aria-describedby="tf1Help" name="prod">
                    ...
                    <div class="form-group">
                      ...
                      <div class="custom-number">
                        <input name="precio"  value="{{ $producto->precio}}" type="number" class="form-control"   >
                      </div>
                    </div><!-- /.form-group -->
                    <div class="form-group">
                        <label for="tf2">Cantidad</label>
                        <div class="custom-number">
                          <input name="cantidad"  value="{{ $producto->cantidad}}" type="number" class="form-control" >
                        </div>
                      </div><!-- /.form-group -->
